...
function Form() {
  ...
  function myStyle(e) {
    if (e.target.value === '')
    setStyle ({borderBottom: '2px solid #0e153a', borderRadius: '0px'});
    else
  ...
  function myStyle1(e) {
    if (e.target.value === '')
    setStyle1 ({borderBottom: '2px solid #0e153a', borderRadius: '0px'});
    else
  ...
  function myStyle2(e) {
    if (e.target.value === '')
    setStyle2 ({borderBottom: '2px solid #0e153a', borderRadius: '0px'});
    else
  ...
  function myStyle3(e) {
    if (e.target.value === '')
    setStyle3 ({borderBottom: '2px solid #0e153a', borderRadius: '0px'});
    else
